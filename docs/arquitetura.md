...
O frontend nunca calcula nada financeiro — apenas envia os dados do formulário e renderiza o que o backend devolve. Toda a matemática (Tabela Price, TR, amortizações, alertas) vive no backend.
...
└── lib/
    ...
    └── componentes/
        ...
        AmortizacoesExtras.svelte     lista editável de aportes FGTS
