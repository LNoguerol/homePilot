...
- Outros indexadores além da TR (o SAC, que estava aqui, foi implementado — ver "✅ Feito").
- Comparar Price e SAC lado a lado em uma única tela, no mesmo formato da comparação de cenários de TR que já existe.
